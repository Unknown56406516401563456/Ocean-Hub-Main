...
elseif PlaceId == 5326405001 then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Unknown56406516401563456/Base-Battles-Ocean-Hub/main/Base%20Battles%20Script.lua"))()
else
	game.Players.LocalPlayer:kick("Please Execute This Only On Ninja Legends, Prison Life, Da Hood Tower Of Hell or Base Battles.")
	wait(10)
	game:Shutdown()
end
